...
use DB;
use JWTAuth;
use Modules\Billing\Http\Requests\InternetCustomerRequest;
...
class InternetCustomerController extends Controller
{
     ...
     * @return Response
     */
    public function store(InternetCustomerRequest $request)
    {
     ...
     * @return Response
     */
    public function update(Customer $customer, InternetCustomerRequest $request)
    {
        $user = JWTAuth::parseToken()->authenticate();
